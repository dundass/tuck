        ...
        data: {
            world: {
                ...
                denizens: [ // global denizen pool - immutable !
                    {name: 'Horald Stinkerby',          standing: 0,        image: manifest.custHorald.src,        asks: ['rockpaper', 'charity', 'random-neg', 'purchase'],                           buys: ['Baskets', 'Bottles and Vials']},
                    {name: 'Fawkes',                    standing: 0,        image: manifest.custFawkes.src,       asks: ['shopowner', 'random-pos', 'purchase', 'mushrooms'],                         buys: ['Baskets','Dungeoneering Kits', 'Herbal Potion'],                                                                        story: 'the letter'},
                    {name: 'Faelyn',                    standing: 20,       image: manifest.custFaelyn.src,        asks: ['suitors', 'random-pos', 'random-neg', 'purchase'],                          buys: ['Herbal Potion','Baskets', 'Bottles and Vials']},
                    {name: 'Baba Yaga',                 standing: 5,        image: manifest.custBaba.src,         asks: ['mushrooms', 'purchase'],                                                    buys: ['Baskets', 'Bottles and Vials', 'Herbal Potion'],                                                                        story: 'the letter'},
                    {name: 'Jack Woodcutter',           standing: 5,        image: manifest.custJack.src,       asks: ['purchase','charity'],                                                       buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear'],                                                                  story: 'jack of all trades'},
                    {name: 'Lady Virbella',             standing: 30,       image: manifest.custLady.src,       asks: ['prize','purchase','charity'],                                               buys: ['Writing Supplies', 'Pan Pipes', 'Lute', 'Fine Clothing'],                                                               story: 'the letter'},
                    {name: 'Gabriel Dragonlord',        standing: 30,       image: manifest.custGabriel.src,       asks: ['random-pos','purchase'],                                                    buys: ['Armour', 'Writing Supplies', 'Pan Pipes', 'Baskets'],                                                                   story: 'dragons den'},
                    {name: 'John Wolfman',              standing: 30,       image: manifest.custJohn.src,                                                                                                                                                                                                                          story: 'dragons den'},
                    {name: 'Jess Hogglestonk',          standing: 0,        image: manifest.custJess.src,     asks: ['purchase', 'random-pos', 'festivals'],                                      buys: ['Baskets', 'Bottles and Vials', 'Herbal Potion'],                                                                        story: 'desperate',},
                    {name: 'Jessica Hogglesworth',      standing: 0,        image: manifest.custJessica.src,     asks: ['purchase', 'random-pos'],                                                   buys: ['Baskets', 'Bottles and Vials', 'Dungeoneering Kits', 'Herbal Potion', 'Camping Gear'],                                  story: 'cured'},
                    {name: 'Shai',                      standing: 0,        image: manifest.custShai.src,                                                                                                                                                                                                                              story: 'the silent'},
                    {name: 'Mayor Jones',               standing: 0,        image: manifest.custMayor.src,        asks:['theft', 'beenbusy', 'random-pos','purchase', 'dailytax'],                    buys: ['Herbal Potion', 'Pan Pipes', 'Writing Supplies'],                                                                       story: 'the repair pt.1'},
                    {name: 'Lord Bapple of Appleshire', standing: 50,       image: manifest.custLord.src,        asks:['goodwords', 'purchase', 'dailytax'],                                         buys: ['Writing Supplies', 'Pan Pipes', 'Lute', 'Fine Clothing'],                                                               story: 'library'},
                    {name: 'Sir Knight',                standing: 55,       image: manifest.custSir.src,       asks:['knights', 'goodwords', 'purchase','random-pos'],                             buys: ['Dungeoneering Kits', 'Armour'],                                                                                         story: 'academy'},
                    {name: 'Uglalk',                    standing: 7,        image: manifest.custUglalk.src,         asks:['random-pos','random-neg', 'purchase'],                                       buys: ['Dungeoneering Kits', 'Herbal Potion']},
                    // WHY is he selfish ?? blackmail
                    {name: 'Almeric the Selfish',       standing: 2,        image: manifest.custAlmeric.src,      asks:['knights', 'blackmail','charity','random-neg', 'purchase'],                   buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour', 'Metal Tools'],                                         story: 'to-village'},
                    ...
                    {name: 'Harry Oldman',              standing: 0,        image: manifest.custHarry.src,       asks:['charity','purchase'],                                                        buys: ['Bottles and Vials', 'Baskets']},
                    {name: 'Homenos Proudhoof',         standing: 10,       image: manifest.custHomenos.src,                                                                                                                                                                                                                           story: 'a horse voice'},
                    {name: 'Vahn Dawnreaper',           standing: 0,        image: manifest.custVahn.src,      asks: ['trinkets', 'purchase'],                                                     buys: ['Dungeoneering Kits', 'Herbal Potion', 'Herbal Potion', 'Fine Clothing'],                                                story: 'demons'},
                    {name: 'Hook Demon',                standing: 0,        image: manifest.custHook.src,      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Baskets', 'Camping Gear', 'Armour', 'Writing Supplies', 'Pan Pipes']},
                    {name: 'Angry Demon',               standing: 0,        image: manifest.custAngry.src,      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Baskets', 'Camping Gear', 'Armour', 'Writing Supplies', 'Pan Pipes']},
                    {name: 'Pink Demon',                standing: 0,        image: manifest.custPink.src,      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour', 'Writing Supplies']},
                    {name: 'Wrapped Demon',             standing: 0,        image: manifest.custWrapped.src,      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour', 'Writing Supplies']},
                    {name: 'Sign Demon',                standing: 0,        image: manifest.custSign.src,      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Metal Tools', 'Fishing Tackle', 'Lute', 'Fine Clothing']},
                    {name: 'Boss Demon',                standing: 0,        image: manifest.custBoss.src,      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Metal Tools', 'Fishing Tackle', 'Lute', 'Fine Clothing']},
                    {name: 'Hugh Molay',                standing: 0,        image: manifest.custHugh.src,    asks: ['knights', 'purchase'],                                                      buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour']},
                    ...
                    {name: 'Samuel Barley',             standing: 0,        image: manifest.custSamuel.src,    asks: ['purchase'],                                                                 buys: ['Baskets', 'Bottles and Vials', 'Dungeoneering Kits']},
                    {name: 'Tony Cryer',                standing: 0,        image: manifest.custTony.src,    asks: ['purchase', 'location'],                                                     buys: ['Herbal Potion', 'Writing Supplies', 'Metal Tools', 'Lute'],                                                             story: 'fireworks'},
                    // {name: 'Tommy Smith',               standing: 0,        image: 'images/customers/generic_5.png',    asks: ['purchase'],                                                                 buys: ['Armour', 'Metal Tools']},
                    {name: 'Bee',                       standing: 0,        image: manifest.custBee.src,    asks: ['bully', 'dolly', 'purchase', 'location'],                                   buys: ['Pan Pipes', 'Camping Gear', 'Writing Supplies']},
                    ...
                    {name: 'Ruth Ordare',               standing: 0,        image: manifest.custRuth.src,    asks: ['purchase', 'random-pos', 'location'],                                       buys: ['Lute', 'Fine Clothing', 'Baskets', 'Writing Supplies']},
                    ...
                    {name: 'Tilly and lil Bill',        standing: 0,        image: manifest.custTilly.src,   asks: ['bully', 'purchase', 'random-pos', 'goodwords'],                             buys: ['Baskets', 'Bottles and Vials', 'Herbal Potion']},
                    {name: 'Brother Gill',              standing: 0,        image: manifest.custBrother.src,   asks: ['goodwords', 'random-pos', 'purchase'],                                      buys: ['Bottles and Vials', 'Herbal Potion', 'Writing Supplies']},
                    {name: 'Abigail Prinn',             standing: 0,        image: manifest.custAbigail.src,   asks: ['purchase', 'random-pos', 'timeofday'],                                      buys: ['Baskets', 'Bottles and Vials']},
                    {name: 'The Fool',                  standing: 0,        image: manifest.custFool.src,      asks: ['littlegamered','littlegamegreen','fool_1','fool_2','fool_3', 'fool_4', 'purchase'],                                     buys: ['Baskets', 'Bottles and Vials', 'Herbal Potion', 'Writing Supplies', 'Lute', 'Fine Clothing', 'Pan Pipes']},
                    {name: 'The Stranger',              standing: 0,        image: manifest.custStranger.src,     asks: ['stranger_1','stranger_2']},
                ...
                */
                ...
                'to-village':{
                    ...
                    stageNo: {
                        ...
                        resYes: ["Hahaa! Knights of the Roadside, assemble!"],
                ...
                'jack of all trades': {
                    ...
                    stageYes: {
                        ...
                        stageYes:{
                            ...
                            stageYes:{      // todo - what is going on here - guess above resYes says see you soon sooo...

                            },
                            stageNo:{       // todo - this is beyond the end ?
