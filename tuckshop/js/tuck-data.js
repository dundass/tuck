        ...
        data: {
            world: {
                areas: [
                    {
                        name: 'roadside',
                        backgroundImage: 'images/ForestBG.png',
                        backgroundImageDark: 'images/ForestBGDark.png',
                        backgroundAudioId: 'forest',
                        items: ['Baskets', 'Bottles and Vials', 'Dungeoneering Kits', 'Herbal Potion', 'Camping Gear'],
                        friends: ['village'],
                        enemies: ['swamp'],
                        denizens: ["Tilly and lil Bill", "Brother Gill", "Abigail Prinn", "The Fool", 'Hugh Molay', 'Hans Bowman', 'Samuel Barley', 'Renford of Swampton', 'Harry Oldman', 'Almeric the Selfish','Uglalk','Sir Knight','Horald Stinkerby','Faelyn','Baba Yaga','Jess Hogglestonk']
                    },
                    {
                        name: 'village',
                        backgroundImage: 'images/Village.png',
                        backgroundImageDark: 'images/VillageDark.png',
                        backgroundAudioId: '',
                        items: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour', 'Writing Supplies', 'Pan Pipes'],
                        friends: ['roadside'],
                        enemies: ['city'],
                        denizens: ["Tilly and lil Bill", "Brother Gill", "Abigail Prinn", "The Fool", "Tommy Smith", 'Tony Cryer', "Bee", "Charles Copley", 'Almeric the Selfish','Sir Knight','Mayor Jones','Shai','Fawkes','Jack Woodcutter','Gabriel Dragonlord','John Wolfman']
                    },
                    {
                        name: 'city walls',
                        backgroundImage: 'images/Citywall.png',
                        backgroundImageDark: 'images/Citywall.png',
                        backgroundAudioId: '',
                        items: ['Camping Gear', 'Armour', 'Writing Supplies', 'Pan Pipes', 'Metal Tools', 'Fishing Tackle', 'Lute', 'Fine Clothing'],
                        friends: [],
                        enemies: [],
                        denizens: ["Tilly and lil Bill", "Brother Gill", "Abigail Prinn", "The Fool", "Ruth Ordare", 'Tony Cryer', "Greta Grumbles", 'Vahn Dawnreaper', 'Almeric the Selfish','Sir Knight','Lady Virbella','Lord Bapple of Appleshire','Homenos Proudhoof']
                    }
                ],
                denizens: [ // global denizen pool - immutable !
                    {name: 'Horald Stinkerby',          standing: 0,        image: 'images/customers/rogue.png',        asks: ['rockpaper', 'charity', 'random-neg', 'purchase'],                           buys: ['Baskets', 'Bottles and Vials']},
                    {name: 'Fawkes',                    standing: 0,        image: 'images/customers/fawkes.png',       asks: ['shopowner', 'random-pos', 'purchase', 'mushrooms'],                         buys: ['Baskets','Dungeoneering Kits', 'Herbal Potion'],                                                                        story: 'the letter'},
                    {name: 'Faelyn',                    standing: 20,       image: 'images/customers/fairy.png',        asks: ['suitors', 'random-pos', 'random-neg', 'purchase'],                          buys: ['Herbal Potion','Baskets', 'Bottles and Vials']},
                    {name: 'Baba Yaga',                 standing: 5,        image: 'images/customers/baba.png',         asks: ['mushrooms', 'purchase'],                                                    buys: ['Baskets', 'Bottles and Vials', 'Herbal Potion'],                                                                        story: 'the letter'},
                    {name: 'Jack Woodcutter',           standing: 5,        image: 'images/customers/farmer.png',       asks: ['purchase','charity'],                                                       buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear'],                                                                  story: 'jack of all trades'},
                    {name: 'Lady Virbella',             standing: 30,       image: 'images/customers/f_cust.png',       asks: ['prize','purchase','charity'],                                               buys: ['Writing Supplies', 'Pan Pipes', 'Lute', 'Fine Clothing'],                                                               story: 'the letter'},
                    {name: 'Gabriel Dragonlord',        standing: 30,       image: 'images/customers/dragon.png',       asks: ['random-pos','purchase'],                                                    buys: ['Armour', 'Writing Supplies', 'Pan Pipes', 'Baskets'],                                                                   story: 'dragons den'},
                    {name: 'John Wolfman',              standing: 30,       image: 'images/customers/wolfman.png',                                                                                                                                                                                                                          story: 'dragons den'},
                    {name: 'Jess Hogglestonk',          standing: 0,        image: 'images/customers/vestal_1.png',     asks: ['purchase', 'random-pos', 'festivals'],                                      buys: ['Baskets', 'Bottles and Vials', 'Herbal Potion'],                                                                        story: 'desperate',},
                    {name: 'Jessica Hogglesworth',      standing: 0,        image: 'images/customers/vestal_2.png',     asks: ['purchase', 'random-pos'],                                                   buys: ['Baskets', 'Bottles and Vials', 'Dungeoneering Kits', 'Herbal Potion', 'Camping Gear'],                                  story: 'cured'},
                    {name: 'Shai',                      standing: 0,        image: 'images/customers/shy.png',                                                                                                                                                                                                                              story: 'the silent'},
                    {name: 'Mayor Jones',               standing: 0,        image: 'images/customers/jones.png',        asks:['theft', 'beenbusy', 'random-pos','purchase'],                                buys: ['Herbal Potion', 'Pan Pipes', 'Writing Supplies'],                                                                       story: 'the repair pt.1'},
                    {name: 'Lord Bapple of Appleshire', standing: 50,       image: 'images/customers/noble.png',        asks:['goodwords', 'purchase'],                                                     buys: ['Writing Supplies', 'Pan Pipes', 'Lute', 'Fine Clothing']},
                    {name: 'Sir Knight',                standing: 55,       image: 'images/customers/knight.png',       asks:['knights', 'goodwords', 'purchase','random-pos'],                             buys: ['Dungeoneering Kits', 'Armour']},
                    {name: 'Uglalk',                    standing: 7,        image: 'images/customers/barb.png',         asks:['random-pos','random-neg', 'purchase'],                                       buys: ['Dungeoneering Kits', 'Herbal Potion']},
                    {name: 'Almeric the Selfish',       standing: 2,        image: 'images/customers/almeric.png',      asks:['knights', 'blackmail','charity','random-neg', 'purchase'],                   buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour', 'Metal Tools'],                                         story: 'to-village'},
                    ...
                    {name: 'Harry Oldman',              standing: 0,        image: 'images/customers/oldman.png',       asks:['charity','purchase'],                                                        buys: ['Bottles and Vials', 'Baskets']},
                    {name: 'Homenos Proudhoof',         standing: 10,       image: 'images/customers/bojack.png',                                                                                                                                                                                                                           story: 'a horse voice'},
                    {name: 'Vahn Dawnreaper',           standing: 0,        image: 'images/customers/warlock.png',      asks: ['trinkets', 'purchase'],                                                     buys: ['Dungeoneering Kits', 'Herbal Potion', 'Herbal Potion', 'Fine Clothing'],                                                story: 'demons'},
                    {name: 'Hook Demon',                standing: 0,        image: 'images/customers/demon_1.png',      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Baskets', 'Camping Gear', 'Armour', 'Writing Supplies', 'Pan Pipes']},
                    {name: 'Angry Demon',               standing: 0,        image: 'images/customers/demon_2.png',      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Baskets', 'Camping Gear', 'Armour', 'Writing Supplies', 'Pan Pipes']},
                    {name: 'Pink Demon',                standing: 0,        image: 'images/customers/demon_3.png',      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour', 'Writing Supplies']},
                    {name: 'Wrapped Demon',             standing: 0,        image: 'images/customers/demon_4.png',      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour', 'Writing Supplies']},
                    {name: 'Sign Demon',                standing: 0,        image: 'images/customers/demon_5.png',      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Metal Tools', 'Fishing Tackle', 'Lute', 'Fine Clothing']},
                    {name: 'Boss Demon',                standing: 0,        image: 'images/customers/demon_6.png',      asks: ['purchase'],                                                                 buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Metal Tools', 'Fishing Tackle', 'Lute', 'Fine Clothing']},
                    {name: 'Hugh Molay',                standing: 0,        image: 'images/customers/generic_1.png',    asks: ['knights', 'purchase'],                                                      buys: ['Dungeoneering Kits', 'Herbal Potion', 'Camping Gear', 'Armour']},
                    ...
                    {name: 'Samuel Barley',             standing: 0,        image: 'images/customers/generic_3.png',    asks: ['purchase'],                                                                 buys: ['Baskets', 'Bottles and Vials', 'Dungeoneering Kits']},
                    {name: 'Tony Cryer',                standing: 0,        image: 'images/customers/generic_4.png',    asks: ['purchase'],                                                                 buys: ['Herbal Potion', 'Writing Supplies', 'Metal Tools', 'Lute']},
                    {name: 'Tommy Smith',               standing: 0,        image: 'images/customers/generic_5.png',    asks: ['purchase'],                                                                 buys: ['Armour', 'Metal Tools']},
                    {name: 'Bee',                       standing: 0,        image: 'images/customers/generic_6.png',    asks: ['bully', 'dolly', 'purchase'],                                               buys: ['Pan Pipes', 'Camping Gear', 'Writing Supplies']},
                    ...
                    {name: 'Ruth Ordare',               standing: 0,        image: 'images/customers/generic_8.png',    asks: ['purchase', 'random-pos'],                                                   buys: ['Lute', 'Fine Clothing', 'Baskets', 'Writing Supplies']},
                    ...
                    {name: 'Tilly and lil Bill',        standing: 0,        image: 'images/customers/generic_10.png',   asks: ['bully', 'purchase', 'random-pos', 'goodwords'],                             buys: ['Baskets', 'Bottles and Vials', 'Herbal Potion']},
                    {name: 'Brother Gill',              standing: 0,        image: 'images/customers/generic_11.png',   asks: ['goodwords', 'random-pos', 'purchase'],                                      buys: ['Bottles and Vials', 'Herbal Potion', 'Writing Supplies']},
                    {name: 'Abigail Prinn',             standing: 0,        image: 'images/customers/generic_12.png',   asks: ['purchase', 'random-pos'],                                                   buys: ['Baskets', 'Bottles and Vials']},
                    {name: 'The Fool',                  standing: 0,        image: 'images/customers/thefool.png',      asks: ['littlegamered','littlegamegreen','fool_1','fool_2','fool_3', 'fool_4', 'purchase'],                                     buys: ['Baskets', 'Bottles and Vials', 'Herbal Potion', 'Writing Supplies', 'Lute', 'Fine Clothing', 'Pan Pipes']},
                    {name: 'The Stranger',              standing: 0,        image: 'images/customers/stranger.png',     asks: ['stranger_1','stranger_2']},

                    {name: 'Comic Sans', standing: 0, story: 'sans', image: 'images/customers/comic.png'},
                    ...
                    // TODO - denizens of the Rock Kingdom
                ...
                items: [    // global item pool
                    ...
                    //actual
                    {name: 'Baskets',               image: 'images/items/Basket.png',           type:'adventure',   value: {'roadside': {buy: 2,sell: 4},        'village': {buy: 2, sell: 5},       'city walls': {sell: 6}},               'returns':1},
                    {name: 'Bottles and Vials',     image: 'images/items/Bottlesandvials.png',  type:'herbalism',   value: {'roadside': {buy: 1,sell: 2},        'village': {sell: 2},               'city walls': {sell: 3}},               'returns':1},
                    {name: 'Dungeoneering Kits',    image: 'images/items/Dungeon.png',          type:'adventure',   value: {'roadside': {buy: 5,sell: 10},       'village': {buy: 5, sell: 12},      'city walls': {sell: 18}},              'returns':1},
                    {name: 'Herbal Potion',         image: 'images/items/HerbalPotion.png',     type:'herbalism',   value: {'roadside': {buy: 10,sell: 25},      'village': {buy: 6, sell: 15},      'city walls': {sell: 15}},              'returns':2},
                    {name: 'Camping Gear',          image: 'images/items/Camp.png',             type:'adventure',   value: {'roadside': {buy: 10,sell: 20},      'village': {buy: 8,sell: 20},       'city walls': {buy: 8,sell: 15}},       'returns':4},
                    {name: 'Armour',                image: 'images/items/Armor.png',            type:'clothing',    value: {'roadside': {sell: 28},              'village': {buy: 12,sell: 25},      'city walls': {buy: 12,sell: 25}},      'returns':6},
                    {name: 'Writing Supplies',      image: 'images/items/Writing.png',          type:'crafting',    value: {'roadside': {sell: 35},              'village': {buy: 22,sell: 40},      'city walls': {buy: 15,sell: 30}},      'returns':8},
                    {name: 'Pan Pipes',             image: 'images/items/Pipes.png',            type:'music',       value: {'roadside': {sell: 65},              'village': {buy: 35,sell: 50},      'city walls': {buy: 20,sell: 60}},      'returns':8},
                    {name: 'Metal Tools',           image: 'images/items/MetalTool.png',        type:'crafting',    value: {'roadside': {sell: 80},              'village': {sell: 75},              'city walls': {buy: 25,sell: 75}},      'returns':10},
                    {name: 'Fishing Tackle',        image: 'images/items/FishingTackle.png',    type:'adventure',   value: {'roadside': {sell: 95},              'village': {sell: 95},              'city walls': {buy: 35,sell: 100}},     'returns':10},
                    {name: 'Lute',                  image: 'images/items/Lute.png',             type:'music',       value: {'roadside': {sell: 100},             'village': {sell: 100},             'city walls': {buy: 38,sell: 120}},     'returns':12},
                    {name: 'Fine Clothing',         image: 'images/items/FineClothing.png',     type:'clothing',    value: {'roadside': {sell: 100},             'village': {sell: 130},             'city walls': {buy: 50,sell: 135}},     'returns':15},

                    //Unique Items, quest rewards etc.
                    {name: 'Cursed Amulet', image: 'images/items/locket.png', type:'unique', value: {'roadside': {buy: 0,sell: 250}, 'village': {buy: 0, sell: 250}, 'city walls': {buy: 0,sell: 250}}, 'returns':250},
                    {name: 'Dragonscale Shield', image: 'images/items/shield.png', type:'unique', value: {'roadside': {buy: 0,sell: 500}, 'village': {buy: 0, sell: 500}, 'city walls': {buy: 0,sell: 500}}, 'returns':500},
                    {name: 'Lilac Tea', image: 'images/items/tea.png', type:'unique', value: {'roadside': {buy: 0,sell: 500}, 'village': {buy: 0, sell: 500}, 'city walls': {buy: 0,sell: 500}}, 'returns':500},
                    {name: 'Handmade Scrapbook', image: 'images/items/book.png', type:'unique', value: {'roadside': {buy: 0,sell: 350}, 'village': {buy: 0, sell: 350}, 'city walls': {buy: 0,sell: 350}}, 'returns':350},
                ],
                events: [
                    {name: 'rain', duration: 2, cancels: ['monsoon', 'troupe'], effects: {start: function() { tw.Utils.addClass(document.getElementsByClassName('weather')[0], 'rain') }, end: function() { tw.Utils.removeClass(document.getElementsByClassName('weather')[0], 'rain') }}},
                    {name: 'monsoon', duration: 3, cancels: ['rain', 'troupe', 'festival'], effects: {start: function() { tw.Utils.addClass(document.getElementsByClassName('weather')[0], 'rain') }, end: function() { tw.Utils.removeClass(document.getElementsByClassName('weather')[0], 'rain') }}},
                    {name: 'war', duration: 6, cancels: ['troupe', 'festival'], effects: {itemMultipliers: {tat: 1.4, fancies: 0.01}, start: function() {}}},
                    {name: 'drought', duration: 4, cancels: ['rain', 'monsoon', 'festival', 'war'], effects: {start: function() { tw.Utils.addClass(document.getElementsByClassName('weather')[0], 'drought') }, end: function() { tw.Utils.removeClass(document.getElementsByClassName('weather')[0], 'drought') }}},    // yellow bright visual effect, also less people ?
                    {name: 'plague', duration: 5, cancels: ['pirateAttack', 'festival', 'troupe'], effects: {start: function() { tw.Utils.addClass(document.getElementsByClassName('weather')[0], 'plague') }, end: function() { tw.Utils.removeClass(document.getElementsByClassName('weather')[0], 'plague') }}},
                    ...
                    {name: 'festival', duration: 7, effects: {start: function(p, ws, m) { tw.Utils.addClass(document.getElementsByClassName('weather')[0], 'festival'); ws.dynamics.denizenFrequency *= 2 }, end: function(p, ws, m) { tw.Utils.removeClass(document.getElementsByClassName('weather')[0], 'festival'); ws.dynamics.denizenFrequency /= 2 }}}  // diff types of festival ?
                ],
                upgrades: [ // banner !
                    {name: 'Potion Rack', desc: 'Sell potions, herbs, and herbal potions!', cost: 250, unlocks: 'Herbal Potion', image: 'images/items/upgrades/PotionRack.png', type: 'herbalism'},
                    {name: 'Wardrobe', desc: 'The finest of robes can\'t just be thrown on the floor!', cost: 600, unlocks: 'Fine Clothing', image: 'images/items/upgrades/Wardrobe.png', type: 'clothing'},
                    {name: 'Tackle Box', desc: 'Fishing equipment like rods, bait, and lures can be stored here.', cost: 550, unlocks: 'Fishing Tackle', image: 'images/items/upgrades/TackleBox.png', type: 'adventure'},
                    {name: 'Stationery Storage', desc: 'From a humble quill to the finest vellum, you can sell it all.', cost: 400, unlocks: 'Writing Supplies', image: 'images/items/upgrades/WritingStorage.png', type: 'crafting'}
                ],
                perks: [
                    {name: 'Advertising', location:"roadside", desc:"Advertising in local papers and noticeboards promotes your shop, causing people to walk past more often.", image:'images/ui/perks/advert.png', start: function(p, ws, m) { ws.dynamics.denizenFrequency *= 1.5 }, end: function(p, ws, m) { ws.dynamics.denizenFrequency *= (2/3) }}, //effects: {'denizenFrequency': 1.2}},
                    {name: 'Herbalist', location:"roadside", desc:"Becoming a Herbalism specialist means that people pay 20% more for items in this class.", image:'images/ui/perks/herb.png', effects: {'herbalist': 1.2}},
                    {name: 'Weaver', location:"roadside", desc:"Making your own products means you don't have to rely on anyone to provide them for you. You'll never run out of baskets now.", image:'images/ui/perks/basket.png', start: function(p, ws, m) { p.inventory['Baskets'] = Infinity }, end: function(p, ws, m) { p.inventory['Baskets'] = 0 }},
                    {name: 'Outfitter', location:"roadside", desc:"Becoming a dedicated seller of clothing ensures any future clothing related shop upgrades cost 20% less.", image:'images/ui/perks/clothes.png', effects: {'clothingShop': 0.8}},

                    {name: 'Charismatic', location:"village", desc:"Being friendly, and having a good rapport with your customers means they are more likely to make better offers when haggling.", image:'images/ui/perks/hands.png', effects: {'haggle': 1.1}},
                    {name: 'Marketing', location:"village", desc:"Good marketing means customers spread the word of how great your shop is. Any reputation gains will increase by 10%.", image:'images/ui/perks/thumb.png', effects: {'reputation': 1.1}},
                    {name: 'Smooth Talker', location:"village", desc:"By being friendly with your stockist, they're more likely to help you. You gain a chance to get free items when restocking.", image:'images/ui/perks/haggle.png', effects: {'restockBonus': true}},
                    {name: 'Haggler', location:"village", desc:"Haggling or bargaining is commonplace in many markets around the world. Customers will now be more likely to make a counter-offer when you refuse them.", image:'images/ui/perks/thinking.png', effects: {'haggleChance': 0.6}},

                    {name: 'Scrounger', location:"city walls", desc:"You have a keen eye, and see opportunity everywhere. You have a small chance of finding special items at the end of each day.", image:'images/ui/perks/shiny.png', effects: {'endOfDayBonus': true}},
                    {name: 'Mysterious Benefactor', location:"city walls", desc:"Many businesses get a helping hand. This perk adds a unique person to the world who occasionally gives you money or reputation.", image:'images/ui/perks/stranger.png', start: function(p, ws, m) { m.addDenizenToPool('The Stranger') }},
                    {name: 'Philanthropist', location:"city walls", desc:"Giving back to the community is good for them, and good your business. You give more money away to those in need, but they give you more reputation in return.", image:'images/ui/perks/coin.png', effects: {'charity': 1.2}},
                    {name: 'Well Mannered', location:"city walls", desc:"By being courteous and polite at all times, refusing a sale to customers now doesn't result in reputation loss.", image:'images/ui/perks/shrug.png', effects: {'declineSale': true}}
                ],
                perkTree: {
                    'Finance': {
                        'Smooth Talker': {
                            desc: "By being friendly with your stockist, they're more likely to help you. You gain a chance to get free items when restocking.",

                            'Scrounger': {
                                desc: "You have a keen eye, and see opportunity everywhere. You have a small chance of finding special items at the end of each day.",
                                tiers: []
                            }
                        },
                        'Haggler': {
                            desc: "Haggling or bargaining is commonplace in many markets around the world. Customers will now be more likely to make a counter-offer when you refuse them.",
                            tiers: [],

                            'Charismatic': {
                                desc: "Being friendly, and having a good rapport with your customers means they are more likely to make better offers when haggling.",
                                tiers: []
                            },
                            'Well Mannered': {
                                desc: "By being courteous and polite at all times, refusing a sale to customers now doesn't result in reputation loss."
                            }
                        },
                        'Good Name': {
                            desc: "",
                        ...
                        'Scry': {
                            desc: "",
                            requires: 'perks["Finance"].length > 5'
                        }
                    },
                    'Denizens': {
                        'Star Reputation': {
                            ...
                            'Marketing': {
                                desc: "Good marketing means customers spread the word of how great your shop is. Any reputation gains will increase by 10%.",
                                tiers: []
                            }
                        },
                        'Advertising': {
                            desc: "Advertising in local papers and noticeboards promotes your shop, causing people to walk past more often.",
                            tiers: ['1.1', '1.2', '1.3', '1.4', '1.5'],

                            'Tuck\'s Fryer': {
                                desc: ""
                            },
                            'Philanthropist': {
                                desc: "Giving back to the community is good for them, and good your business. You give more money away to those in need, but they give you more reputation in return.",

                                'Mysterious Benefactor': {
                                    desc: "Many businesses get a helping hand. This perk adds a unique person to the world who occasionally gives you money or reputation."
                                }
                            }
                        },
                        'Good Listener': {
                        ...
                        'Unsavoury Character': {
                            desc: "",
                            requires: 'perks["Denizens"].length > 5'
                        },
                        'Snob': {
                            desc: "",
                            requires: 'perks["Denizens"].length > 5'
                    ...
                    'Upkeep': {
                        'Herbalist': {
                            desc: "Becoming a Herbalism specialist means that people pay 20% more for items in this class.",
                        ...
                        'Crafter': {
                            ...
                            'Targeted Advertising': {
                                ...
                                'Weaver': {
                                    desc: "Making your own products means you don't have to rely on anyone to provide them for you. You'll never run out of baskets now."
                                }
                            }
                        },
                        'Shop Upgrades': {
                            desc: "",
                            requires: 'perks["Upkeep"].length > 5'
                        }
                    }
                }
            },
            ...
            questions: {
                ...
                'random-pos': {
                    text:['Lovely day isn\'t it?',
                          ...
                          'Aren\'t my eyes the most lovely shade of grey?',
                          'Should I head back and do my chores?',
                          'Does my hair look nice like this?',
                          ...
                          'Should I ask to marry the Fae Princess?',
                ...
                'location': {
                    text: function (player, worldState, methods) {
                        ...
                        var areaOrder = areas.map(function (area) {
                            return area.name
                        });
                ...
                'suitors':{
                    text: ["You! Have you been telling people to come and ask for my hand in marriage?"],
                ...
                'goodwords':{
                    text: ["Hello there! Nice place you have here! For a mere 20 gold I can tell people some good " +
                    "things about you. Interested?"],
                    ...
                    yes: function(player, worldState, methods){
                        methods.modifyCurrency(-worldState.customerBuys.value);
                ...
                'bully':{
                    text: ["Hello! Has that nasty bully been round yet? She\'ll try and make you give her money and " +
                    "threaten you."],
                ...
                'mushrooms':{
                    text: ["Do you have a spare moment to talk about the amazing health benefits of locally " +
                    "sourced Swamp Mushrooms?"],
                ...
                'festivals':{
                    ...
                    resNo: ["Oh wow they\'re super fun! Loads of people from all around turn up! I bet you\'d make " +
                    "lots of money during a festival!"]
                },
                ...
                'knights':{
                    text: ["Ha! There\'s no-one as strong as me! I\'m the strongest one of them all! Do you " +
                    "agree with me?"],
                ...
                'theft':{
                    text: ["Someone has tried to steal trinkets and baubles from my fine coffers. Do you know " +
                    "anything about this?"],
                    resYes: ["Well I never! I expect better of you in the future. Perhaps a fine will straighten " +
                    "you out!"],
                ...
                'prize':{
                    text: ["Congratulation! You\'ve won \'Tiny Little Business of the Week!\' Your prize is a very tidy " +
                    "sum of 50 gold! Isn\'t that great?"],
                ...
                */
                ...
                'the letter':{
                    ...
                    stageYes: {
                        ...
                        "You\'ve met her right? Very pretty! Will you go get her something nice from me?"],
                        ...
                        stageYes: {
                            ...
                            stageYes: {
                                story: true,
                                denizen: 'Fawkes',
                                text: ["That dress! Incredible. Thank you for fetching this, Tuck, it must have cost so much! " +
                                "Let me guess: 1000 gold?"],
                                ...
                                stageYes: {
                                    ...
                                    resYes: ["Oh dear, oh dear. Was it worth it. For a few hundred gold? Shame on you Tuck, shame " +
                                    "on you!"],
                                    resNo: ["Oh dear, Tuck..."],
                                    yes: function(player, worldState, methods){
                ...
                'the repair pt.1':{
                    ...
                    stageYes: { //R1
                        ...
                        stageYes: { //R3
                            ...
                            resYes: ["I don\'t know what to say. Wonderful! The repairs should cost 5000 gold. A trifling sum! " +
                            ...
                            stageYes: {
                                story: true,
                                denizen: 'Mayor Jones',
                                text: ["Ah Tuck! You\'re back! How has the fundraising been going? Do you have the 5000 gold yet?"],
                                resYes: function(player){
                                    if(player.stats.currency >= 5000){
                                        ...
                                        return ["Whoops, doesn\'t look like you do have 5000 gold after all! Don\'t worry, I'm sure you'll get it in no time!"]
                                    }
                ...
                'demons':{
                    ...
                    "glory! All I need to do is open a tiny-weeny portal to the demon realm. Shall I go ahead?"],
                    ...
                    stageYes: {
                        text: ["Hmmm... Well I might have made a tiny error in my calculations. Looks like instead of opening a demon portal, " +
                        "I\'ve turned some people into demons instead. Easy mistake to make. Shall I switch them back?"],
                        resYes: ['Probably for the best. There might be one or two demons still hanging around, but ' +
                        'they\'re mostly harmless. I think.'],
                        resNo: ['Hmmm, suit yourself. Maybe they like being demons...'],
                        yes: function(player, worldState, methods){
                ...
                'cured':{
                    ...
                    stageYes: {
                        ...
                        stageNo: { //YY
                            ...
                            resNo: ["Not to worry, I'll speak to you you later!"],
                            yes: function(player, worldState, methods){
                                methods.modifyReputation(15);
                                methods.modifyCurrency(100);
                            },
                    ...
                    stageYes: { //ts-1
                        ...
                        stageYes: { //ts-2
                            ...
                            stageYes: { //ts-3
                                ...
                                stageYes: { //ts-4
                                    denizen: 'Shai',
                                    text   : ['... Wow... You\'re such a great listener... Could I... Maybe give you' +
                ...
                'dragons den':{
                    ...
                    stageYes: { //dd-1
                        ...
                        stageNo: { //dd-3
                            ...
                            stageYes: { //dd-5
                                denizen: 'John Wolfman',
                                text: ["Arooo! The guard need a second opinion. Apparantly that Dragon isn\'t a problem " +
                ...
                'a horse voice': {
                    ...
                    stageYes: {
                        ...
                        resYes: ['Haha, you look so stupid! Thanks, I\'m a god compared to you. Have some money for your trouble'],
                        resNo: ['I\'m doomed!'],
                        yes: function (player, worldState, methods) {
                            methods.modifyReputation(-3);
                            methods.modifyCurrency(50);
